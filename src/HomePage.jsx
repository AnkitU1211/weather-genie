...
const HomePage = () => {
    ...
    const [showHelpButton, setShowHelpButton] = useState(false); // New state
    ...
    const handleSummonGenie = useCallback(() => {
        ...
        setIsGenieActive(true); // Directly activate Genie
        setTimeout(() => {
            isProcessingRef.current = false;
        }, 1000); // 1s debounce
    }, []);

    // Close Documentation and Activate Genie (not used directly now)
